<div class="bg-gray-900 text-white p-4 rounded-2xl shadow-lg flex flex-col h-full max-h-[500px]">
    ...
    <div class="space-y-3 overflow-y-auto flex-grow pr-2 custom-scroll-clean">
        ...
        <div class="grid grid-cols-3 gap-3 w-full text-center">
            ...
            <div class="bg-gray-800/50 border border-green-500/20 rounded-xl py-5 flex flex-col items-center justify-center hover:bg-gray-800 transition-colors shadow-inner">
            ...
            <div class="bg-gray-800/50 border border-red-500/20 rounded-xl py-5 flex flex-col items-center justify-center hover:bg-gray-800 transition-colors shadow-inner">
                <div class="relative flex h-3 w-3 mb-3">
            ...
            <div class="bg-gray-800/50 border border-blue-500/20 rounded-xl py-5 flex flex-col items-center justify-center hover:bg-gray-800 transition-colors shadow-inner">
