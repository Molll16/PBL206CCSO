      ...
      <div class="flex items-center gap-3 pr-3">
        ...
        <div class="relative">
          ...
          <div id="manage-menu"
            ...
            <a href="#" class="block px-4 py-3 text-xs text-center hover:bg-[#2c2c2c] transition">Switch Agent</a>
            <a href={{ Route('pilih-dasbor') }} class="block px-4 py-3 text-xs text-center hover:bg-[#2c2c2c] transition">Custom Dashboard</a>
            <a href={{ route('login') }} class="block px-4 py-3 text-xs text-center hover:bg-[#2c2c2c] transition">Logout</a>
          </div>
        </div>

        <a href={{ Route('pilih-dasbor') }} class="flex items-center justify-center w-9 h-9 border border-white rounded-md text-lg hover:bg-[#2c2c2c] transition">
          +
        </a>
      </div>
